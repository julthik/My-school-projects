<nav class="navbar-expand-lg navbar-light bg-light">
        <ul class="nav nav-pills nav-fill">
            <li class="nav-item nav-link"><a class="nav-link" href="#"><img src="/images/news.png" width="25" height="25" class="d-inline-block align-top">&nbsp;News</a></li>
            <li class="nav-item nav-link"><a class="nav-link" href="#"><img src="/images/rss.png" width="25" height="25" class="d-inline-block align-top">&nbsp;RSS</a></li>
                        @guest
